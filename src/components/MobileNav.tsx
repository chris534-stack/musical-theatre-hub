...
import { Home, CalendarDays, UserPlus, Users, Newspaper } from 'lucide-react';
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                'flex flex-col items-center justify-center text-center px-0 py-2 rounded-md transition-colors w-1/5',
